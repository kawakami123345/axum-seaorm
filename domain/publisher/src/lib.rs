...
pub trait Repository: Sync + Send {
    ...
    async fn create(&self, item: Publisher) -> anyhow::Result<()>;
    async fn update(&self, item: Publisher) -> anyhow::Result<()>;
    async fn delete(&self, item: Publisher, deleted_by: Uuid) -> anyhow::Result<()>;
}
